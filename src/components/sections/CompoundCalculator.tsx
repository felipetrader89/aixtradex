            ...
            <div className="flex gap-1">
              {RATE_OPTIONS.map((r) => (
                <button
                  ...
                  className={
                    ratePercent === r
                      ? "rounded-md bg-brand-accent px-[19px] py-[10px] text-xs font-semibold text-brand-bg transition-transform hover:scale-[1.02]"
                      : "rounded-md border border-brand-hairline px-[19px] py-[10px] text-xs font-semibold text-brand-ink-dim transition-colors hover:border-brand-accent hover:text-brand-accent"
                  }
                >
                  {r}%
                </button>
